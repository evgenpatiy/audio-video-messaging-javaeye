...
import ua.itea.javaeye.handler.frame.FrameEncoder;

@Slf4j
public class H264Encoder extends OneToOneEncoder {
    ...
    public H264Encoder(Dimension dimension, boolean usingInternalFrameEncoder) {
        super();
